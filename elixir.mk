...
PRODUCT_BUILD_PROP_OVERRIDES += \
    BUILD_FINGERPRINT=Xiaomi/kenzo/kenzo:6.0.1/MMB29M/V9.2.4.0.MHOMIEK:user/release-keys \
    PRIVATE_BUILD_DESC="kenzo-user 6.0.1 V9.2.4.0.MHOMIEK release-keys"
endif
